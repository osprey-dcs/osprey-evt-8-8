# EVT-8-8 System Setup

This document describes setting up a new EVT-8-8 installation.

## Prerequisites

1. One or more EVT-8-8 chassis
  - One 12V power supply for each
  - Ground connection (essential for measurement accuracy!)
2. Time server with 5V TTL PPS output <span style="color:red">Is this needed?</span>
