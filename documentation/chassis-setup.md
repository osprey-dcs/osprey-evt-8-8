# EVT-8-8 Chassis Setup and Recovery

This document describes a process to discover or set
the unique identifiers and firmware of a EVT-8-8
...
$ python3 -m alluvium 192.168.79.8 program app evt-yyyymmdd-123456.bit
```
...
EVT chassis are shipped with IP and MAC of the forms: `192.168.79.ddd` and `12:55:55:00:1f:XX`
...
Network mask and gateway are separately configured for the EVT application fireware,
...
Note: the bootloader firmware will respond to a ping (ICMP), the application firmware will not.
      So for this test first stop any EVT IOC from communication with the chassis.
