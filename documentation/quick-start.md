...
* Software processes
  * [Event & Timing IOC](ioc-setup.md#prerequisites) (required)
  * Control System Studio/Phoebus GUI client

## Preparation

* Install [Event & Timing IOC](ioc-setup.md#prerequisites) and associated software
...
1. Build [Event & Timing IOC](ioc-setup.md#prerequisites) and dependencies.
2. Edit `iocBoot/iocEVT/node01.cmd` with selected [correct IP address](ioc-setup.md#ioc-configuration), then run.
3. Check <span style="color:red">LOOK UP PV</span> Firmaware PV
